...
const startMessage = `
Welcome To Shivpal Singh Torrent Bot
Get Your Download On sltindia.ml
...
Thanks 
For Support Contact @shivriyan 
To Make Your Own Bot Meet @shivriyan
`;
...
function bot(torrent, bot) {
  ...
  bot.onText(/\/serverdisk (.+)/, async (msg, match) => {
  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    if (link.indexOf("magnet:") !== 0) {
      ...
      bot.sendMessage(from, "🥳Started Relax n Wait");
      try {
